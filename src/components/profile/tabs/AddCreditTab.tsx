...
interface AddCreditTabProps {
  profile: UseProfileReturn
}

export function AddCreditTab({ profile }: AddCreditTabProps) {
  const {
    user,
    addCreditAmount,
    setAddCreditAmount,
  ...
  return (
    <TabsContent value="addCredit" className="mt-0 space-y-6 pb-4">
            ...
            <div className="rounded-lg border bg-muted/30 p-5">
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="flex items-center justify-between border-b border-border/30 pb-3">
                  ...
                  <span className="font-medium">
                    {addCreditAmount
                      ? formatCurrency(parseFloat(addCreditAmount))
                      : "$0.00"}
                  </span>
                </div>
                <div className="flex items-center justify-between pb-1 pt-1">
                  ...
                  <span className="font-medium text-primary">
                    {formatCurrency(
                      user.walletBalance +
                        (addCreditAmount ? parseFloat(addCreditAmount) : 0)
                    )}
                  </span>
                </div>
              </div>
